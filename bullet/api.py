...
class HoleCollection():
    ...
    def count_imperial_threaded(self):
        imperial_collection = [o for o in self.holes if o.Units==0 and o.Subtype == "Standard Thread"]
        return len(imperial_collection)

    @property
    def count_metric_threaded(self):
        metric_collection = [o for o in self.holes if o.Units==1 and o.Subtype == "Standard Thread"]
        return len(metric_collection)
